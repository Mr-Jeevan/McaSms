...
import {
    getMcaOneStudents, // Changed from getMcaTwoStudents
    addMcaOneStudent, // Changed from addMcaTwoStudent
...
const McaOne = () => {
    ...
    useEffect(() => {
        const fetchStudents = async () => {
            try {
                const data = await getMcaOneStudents(); // Changed from getMcaTwoStudents
    ...
    const handleEditToggle = async () => {
        if (editMode) {
            ...
            for (const [studentId, fields] of updates) {
                ...
                try {
                    const saved = await updateMcaOneStudent(studentId, { data: dataOnly }); // Changed from updateMcaTwoStudent
                    setStudents((prev) =>
                        prev.map((s) =>
    ...
    const handleAddStudent = async () => {
        ...
        try {
            const saved = await addMcaOneStudent({ data: newStudent }); // Changed from addMcaTwoStudent
                                    ...
                                    <div className="col-md-6 mb-3">
                                        <div className="d-grid gap-2 d-md-flex justify-content-md-end">
                                            <button
                                                ...
                                                onClick={() =>
                                                    exportFilteredToExcel(
                                                        displayedStudents,
                                                        "Mca_1_filtered.xlsx", // Changed export file name
                                                        selectedColumns
                                                    )
                                                }
                                            >
                                            ...
                                            <button
                                                ...
                                                onClick={() =>
                                                    exportToExcel(displayedStudents, "Mca_1_all.xlsx") // Changed export file name
                                                }
                                            >
                                                Export All
                                            </button>
...
export default McaOne; // Changed component export name